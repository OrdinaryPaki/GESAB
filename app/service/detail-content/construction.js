export const constructionDetailContent = {
  rivningsarbeten: {
    ...
    heroImage: "/images/services/rivningsarbeten/hero-partition-removal.webp",
    ...
    supportingImage: "/images/services/rivningsarbeten/project-07-demolition-planning.webp",
    supportingImageAlt: "Rivning: kontrollerad borttagning inför återbyggnad",
    projects: [
      {
        src: "/images/services/rivningsarbeten/project-01-kitchen-stripout.webp",
        alt: "Kontrollerad rivning av köksinredning med skyddat golv",
        caption: "Köket plockas ned i rätt ordning medan golv och angränsande ytor skyddas.",
      },
      {
        src: "/images/services/rivningsarbeten/project-02-bathroom-to-studs.webp",
        alt: "Badrum rivet till reglar och betonggolv",
        caption: "Badrummet är tömt och installationerna säkrade inför kontroll och återuppbyggnad.",
      },
      {
        src: "/images/services/rivningsarbeten/project-03-sorted-materials.webp",
        alt: "Rivningsmaterial sorterat i separata högar",
        caption: "Trä, skivor och säckat avfall sorteras redan inne på arbetsplatsen.",
      },
      {
        src: "/images/services/rivningsarbeten/project-04-dust-barrier-hall.webp",
        alt: "Skyddad hall och dammbarriär under rivning",
        caption: "Dammbarriär och täckta gångvägar skyddar resten av bostaden under arbetet.",
      },
      {
        src: "/images/services/rivningsarbeten/project-05-two-workers.webp",
        alt: "Två hantverkare utför kontrollerad innerväggsrivning",
        caption: "Rivningen sker stegvis och samordnat, med sortering direkt på arbetsplatsen.",
      },
      {
        src: "/images/services/rivningsarbeten/project-06-tile-removal.webp",
        alt: "Kontrollerad kakelrivning med dammutsug",
        caption: "Kakel tas bort med dammutsug nära verktyget för en renare arbetsmiljö.",
      },
      {
        src: "/images/services/rivningsarbeten/project-07-demolition-planning.webp",
        alt: "Planering och markering inför rivningsarbete",
        caption: "Ytor och gränser markeras innan start så att rätt delar tas bort och resten skyddas.",
      },
      {
        src: "/images/services/rivningsarbeten/project-08-clean-shell.webp",
        alt: "Rent och tömt rum efter avslutat rivningsarbete",
        caption: "Ytan lämnas städad och klar för kontroll och nästa byggmoment.",
      },
    ],
  ...
  bygg: {
    ...
    heroImage: "/images/services/bygg/hero-new-doorway-opening.webp",
    ...
    supportingImage: "/images/services/bygg/project-07-casing-carpenter.webp",
    supportingImageAlt: "Bygg: ombyggnad med samordnade moment",
    projects: [
      {
        src: "/images/services/bygg/project-01-partition-storage.webp",
        alt: "Ny innervägg med dörr och platsbyggd förvaring",
        caption: "Ny rumsindelning och förvaring byggs som en samlad del av bostaden.",
      },
      {
        src: "/images/services/bygg/project-02-attic-conversion.webp",
        alt: "Färdig vind med arbetsplats och platsbyggd förvaring",
        caption: "Vindens snedtak utnyttjas med nya ytor, förvaring och en praktisk arbetsplats.",
      },
      {
        src: "/images/services/bygg/project-03-staircase-carpentry.webp",
        alt: "Färdig trappa och trappräcke i ek",
        caption: "Trappa, handledare och vägganslutningar färdigställs som en stabil helhet.",
      },
      {
        src: "/images/services/bygg/project-04-rowhouse-opening.webp",
        alt: "Färdig öppning mellan kök och matplats i radhus",
        caption: "En ny öppning knyter ihop kök och matplats med ett stabilt och färdigt avslut.",
      },
      {
        src: "/images/services/bygg/project-05-built-in-shelving.webp",
        alt: "Platsbyggd bokhylla och förvaring i vardagsrum",
        caption: "Platsbyggd förvaring anpassas efter rummets mått och äldre väggar.",
      },
      {
        src: "/images/services/bygg/project-06-structural-opening.webp",
        alt: "Färdig öppning mellan kök och vardagsrum",
        caption: "Öppningen mellan rummen är färdigställd med gemensamt golv och rena anslutningar.",
      },
      {
        src: "/images/services/bygg/project-07-casing-carpenter.webp",
        alt: "Snickare monterar dörrfoder med vattenpass",
        caption: "Dörrfoder passas in och kontrolleras innan målning och slutfinish.",
      },
      {
        src: "/images/services/bygg/project-08-pre-handover.webp",
        alt: "Nästan färdig ombyggnad med ny öppning och platsbyggd förvaring",
        caption: "De sista detaljerna kontrolleras medan golvskyddet fortfarande ligger kvar.",
      },
    ],
